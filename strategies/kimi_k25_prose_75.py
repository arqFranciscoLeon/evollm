...
class Aggressive_4(LLM_Strategy):
  ...
  def strategy(self, opponent: axl.player.Player) -> axl.Action:
      ...
      if self._punishment_mode:
          if round_number - self._punishment_start < 2:
              return axl.Action.D
      ...
      if self.history[-1] == axl.Action.C and opponent.history[-1] == axl.Action.D:
          ...
          self._punishment_start = round_number
          return axl.Action.D
...
class Aggressive_12(LLM_Strategy):
  ...
  def strategy(self, opponent: axl.player.Player) -> axl.Action:
      ...
      if self.mutual_cooperation_established and opp_last == axl.Action.D:
          return axl.Action.D
      ...
      if my_last == axl.Action.C and opp_last == axl.Action.D and not self.mutual_cooperation_established:
          return axl.Action.D
  ...
  def strategy(self, opponent: axl.player.Player) -> axl.Action:
      ...
      if len(self.history) >= 1 and len(opponent.history) >= 1:
          if (
              self.history[-1] == axl.Action.D
              and opponent.history[-1] == axl.Action.D
              and not self._used_reset
          ):
              self._used_reset = True
              return axl.Action.C
...
class Aggressive_25(LLM_Strategy):
  ...
  def strategy(self, opponent: axl.player.Player) -> axl.Action:
      ...
      if len(self.history) >= 2:
          if self.history[-2] == axl.Action.C and self.history[-1] == axl.Action.D:
