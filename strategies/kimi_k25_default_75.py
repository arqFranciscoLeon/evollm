...
class Aggressive_13(LLM_Strategy):
  ...
  def strategy(self, opponent: axl.player.Player) -> axl.Action:
      if self.first_round():
          self._testing_cooperation = False
          self._testing_round = False
          self._permanent_defect = False
          self._coop_streak_while_defecting = 0
          return axl.Action.D
      ...
      if getattr(self, "_testing_round", False):
          self._testing_round = False
      ...
      if getattr(self, "_testing_cooperation", False):
      ...
      if last_opp == axl.Action.C:
          if last_self == axl.Action.D:
              self._coop_streak_while_defecting += 1
          else:
              self._coop_streak_while_defecting = 0
      else:
          self._coop_streak_while_defecting = 0
  
      if self._coop_streak_while_defecting >= 10:
          self._testing_cooperation = True
          self._testing_round = True
          self._coop_streak_while_defecting = 0
          return axl.Action.C
