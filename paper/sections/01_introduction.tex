...
Willis et al.\ \cite{Willis2025_llm_ipd} provided the first systematic treatment
...
Three contributions follow from this design. First, we extend the Willis et al.\
benchmark to four new frontier models and three providers, enabling the first
cross-provider comparative analysis; H1 is confirmed in 9 of 12 model-prompt
...
across conditions, \ICD ranges from 0.71 to 0.91, with Claude~Sonnet~4.6 under
Self-Refine prompting reaching the highest value in the dataset (0.913). Third,
...
Flash produces aggressive equilibria in up to 70\% of biased-population runs,
while GPT-5.4~Mini reaches 68\% cooperative equilibria under Refine prompting,
