...
We extended the Willis et al.\ \cite{Willis2025_llm_ipd} \LLM evolutionary
...
$\Delta_{\text{noise}} \approx 12$~pp, essentially matching the 13~pp
reported for Claude~3.5~Sonnet in the original benchmark, and biased noisy
conditions push aggressive equilibria above 67\% in 10 of 12
configurations across all models tested.
