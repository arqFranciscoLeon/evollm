...
model generation: ten of twelve model--prompt combinations favour cooperative
equilibria in balanced noiseless conditions, and within the Anthropic lineage
Claude~4.6 closely tracks its predecessor in the balanced condition.
What differentiates outcomes is not which generation a model belongs to but
which provider trained it. Gemini~2.5~Flash reaches up to 77\% aggressive
equilibria; GPT-5.4~Mini reaches up to 70\% cooperative under Self-Refine.
...
consistently across all four models, including Gemini~3.1~Pro Refine at \ICD = 0.925, the dataset maximum.
